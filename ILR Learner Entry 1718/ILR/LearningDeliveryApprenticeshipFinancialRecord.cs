...
namespace ILR
{
    public class ApprenticeshipFinancialRecord : ChildEntity, IDataErrorInfo
    {
        ...
        public DateTime? AFinDate { get { string TBFinDate = XMLHelper.GetChildValue("AFinDate", Node, NSMgr); return (TBFinDate != null ? DateTime.Parse(TBFinDate) : (DateTime?)null); } set { XMLHelper.SetChildValue("AFinDate", value, Node, NSMgr); OnPropertyChanged("AFinDate"); } }
