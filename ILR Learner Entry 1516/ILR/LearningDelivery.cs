...
namespace ILR
{
    public class LearningDelivery : ChildEntity, IDataErrorInfo
    {
        ...
        public bool ShouldProbablyMigrate
        {
            get
            {
                DateTime firstAug2013 = new DateTime(2013, 8, 1);
                switch (this.AimType)
                {
                    case 1:
                    case 4:
                    case 5:
                        if (this.LearnPlanEndDate >= firstAug2013)
                            return this.LearnActEndDate == null || (this.Outcome == 4 || this.Outcome == 5 || this.Outcome == 6);
                        else
                            return false;
                    case 3:
                        return this.LearnPlanEndDate >= firstAug2013 && this.LearnActEndDate == null;
                }
                return false;
            }
        }
        ...
        public List<TrailblazerApprenticeshipFinancialRecord> TrailblazerApprenticeshipFinancialRecordList = new List<TrailblazerApprenticeshipFinancialRecord>();
        ...
        internal LearningDelivery(LearningDelivery MigrationLearningDelivery, XmlNode Node, XmlNamespaceManager NSMgr)
        {
            ...
            if (MigrationLearningDelivery.FundModel != 82)
                this.FundModel = MigrationLearningDelivery.FundModel;
            if (MigrationLearningDelivery.ProgType < 15 || MigrationLearningDelivery.ProgType > 18)
            ...
            if (MigrationLearningDelivery.FundModel != 70)
            ...
            if (MigrationLearningDelivery.Outcome == 4 || MigrationLearningDelivery.Outcome == 5)
                this.Outcome = 8;
            else
        ...
        public void Delete(ChildEntity Child)
        {
            ...
            switch (Child.GetType().ToString())
            {
                case "ILR.LearningDeliveryFAM":
                    ...
                    break;
                case "ILR.TrailblazerApprenticeshipFinancialRecord":
                    this.TrailblazerApprenticeshipFinancialRecordList.Remove((TrailblazerApprenticeshipFinancialRecord)Child);
                    break;
