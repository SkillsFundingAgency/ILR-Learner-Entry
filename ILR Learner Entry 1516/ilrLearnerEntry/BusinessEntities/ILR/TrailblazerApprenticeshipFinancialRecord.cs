...
namespace ILR
{
    public class TrailblazerApprenticeshipFinancialRecord : ChildEntity, IDataErrorInfo
    {
        ...
        #region Constructors
        internal TrailblazerApprenticeshipFinancialRecord(XmlNode TrailblazerApprenticeshipFinancialRecordNode, XmlNamespaceManager NSMgr)
        {
            this.Node = TrailblazerApprenticeshipFinancialRecordNode;
            this.NSMgr = NSMgr;
        }
        #endregion
        ...
        public string this[string columnName]
        {
            get
            {
				...
				if (columnName == "TBFinAmount")
				{
					if (TBFinAmount != null)
					{
						if (TBFinAmount.ToString().Length > 8)
						{
